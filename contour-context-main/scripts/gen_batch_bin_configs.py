...
if __name__ == "__main__":
    ...
    #dir_lid_bin = "/home/lewis/Downloads/datasets/kitti_raw/2011_10_03/2011_10_03_drive_0027_sync/velodyne_points/data"
     #dir_lid_bin = "/media/zgy/zgy/loop_closure/08/velodyne"
     #fp_pose = "/media/zgy/zgy/loop_closure/08/poses.txt"
     #fp_times = "/media/zgy/zgy/loop_closure/08/times.txt"
     #fp_calib = "/media/zgy/zgy/loop_closure/08/calib.txt"
     #sav_1 = "/home/zgy/ROS/contour-context/src/sample_data/ts-sens_pose-kitti00.txt"
     #sav_2 = "/home/zgy/ROS/contour-context/src/contour-context/sample_data/ts-lidar_bins-kitti00.txt"

    ksq = "05"
    # KITTI08
    dir_lid_bin = "/media/zgy/zgy/loop_closure/%s/velodyne" % ksq
     # dir_lid_bin = "/home/lewis/Downloads/datasets/sequences/velodyne"
     # dir_lid_bin = "/media/lewis/OS/downloads/sequences/velodyne"
    fp_pose = "/media/zgy/zgy/loop_closure/%s/poses.txt" % ksq
    fp_times = "/media/zgy/zgy/loop_closure/%s/times.txt" % ksq
    fp_calib = "/media/zgy/zgy/loop_closure/%s/calib.txt" % ksq
    sav_1 = "/home/zgy/ROS/contour_context/src/contour-context-main/sample_data/ts-sens_pose-kitti%s.txt" % ksq
    sav_2 = "/home/zgy/ROS/contour_context/src/contour-context-main/sample_data/ts-lidar_bins-kitti%s.txt" % ksq

    # Onboard ssd:
    #dir_lid_bin = "/zgy/zgy/loop_closure/08/velodyne" % ksq
